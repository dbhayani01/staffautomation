...
async def list_emails(connection: DbConnection, current_staff: CurrentStaff) -> InboxResponse:
    ...
    try:
        async with httpx.AsyncClient(timeout=15) as client:
            response = await client.post(
                ...
                headers={"Authorization": f"Bearer {settings.n8n_outbound_webhook_token}"},
                json={
        ...
        raise HTTPException(
            ...
            detail="Outbound mail webhook failed.",
        ) from exc
